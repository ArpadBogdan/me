...
def set_it_on_fire(input_string="very naughty boy") -> str:
    ...
    """
    str_separator = list(input_string)

    list_length = int(len(input_string))

    n = 0
    for i in range(list_length):
        str_separator.insert(n, "🔥")
        n = n + 2

    str_separator.append("🔥")

    string = "".join(map(str, str_separator))
